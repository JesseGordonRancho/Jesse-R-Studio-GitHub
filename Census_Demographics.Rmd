...
district_colnames <- c("Pct1_Name", "Pct2_Name", "Pct3_Name","District_White", "District_Non_White", "District_Size")
...
for (Pct1_input in 1:nrow(contiguity_adjacent)) {  
  ...
  for (Pct2_input in 1:nrow(pct1_contiguity)) {  
    ...
    pct2_white_size <- pct2_contiguity$Precinct_White[Pct2_input]
    pct2_non_white_size <- pct2_contiguity$Precinct_Non_White[Pct2_input]
    for (Pct3_input in 1:nrow(pct2_contiguity)) {  
      ...
      pct3_white_size <- pct3_contiguity$Precinct_White[Pct3_input]
      pct3_non_white_size <- pct3_contiguity$Precinct_Non_White[Pct3_input]
      if (pct1_name != pct2_name & pct1_name != pct3_name) {
        ...
        district_info <- district_info %>% add_row("Pct1_Name" = pct1_name, "Pct2_Name" = pct2_name, "Pct3_Name" = pct3_name, "District_White" = district_white, "District_Non_White" = district_non_white, "District_Size" = district_size)
