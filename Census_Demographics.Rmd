...
contiguity_core <- demographic_info %>% 
  ...
  select (Precinct_Name, Precinct_Status)
...
There are numerous "excess" precincts too (like Boston) -- they're in red in the original XLS spreadsheet, and we reomve them here by seeing if their name is valid (if it exists in non-core precincts)
